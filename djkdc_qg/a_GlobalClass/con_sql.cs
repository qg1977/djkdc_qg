...
namespace djkdc_qg.a_GlobalClass
{
     public class con_sql
    {
        ...
        public static void create_cn()
        {
            ...
            //connectString = "server=DELL-17;database=books;uid=sa;pwd=shengda;Connect Timeout=150";
            //connectString = "server=10.82.10.143;database=books;uid=sa;pwd=h@abc123;Connect Timeout=15";
            connectString = "server=61.184.89.205,1434;database=books;uid=sa;pwd=qg1977721@163.net;Connect Timeout=15";
            //}
