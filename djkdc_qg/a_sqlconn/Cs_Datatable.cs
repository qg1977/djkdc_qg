        ...
        public static void ExportExcel(DataGridView myDGV, string dy_title, string dy_month)
        {
            ...
            {               
                ...
                try
                {
                    ...
                    #region 将标题行 居中 线框加粗  字体加大
                    excelRange = worksheet.get_Range(startCol + "3", endCol + "3");
                    excelRange.HorizontalAlignment = Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignCenter;//水平居中  
                    excelRange.Borders.LineStyle = 2;//边框加粗
                    excelRange.Font.Bold = true;
                    excelRange.Font.Size = excelRange.Font.Size + 2;
                    #endregion
