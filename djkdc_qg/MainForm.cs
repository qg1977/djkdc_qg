...
namespace djkdc_qg
{
    public partial class MainForm : Form
    {
        public MainForm()
        {
            ...
            Text = "图书管理系统";
            toolStripStatusLabel2.Text = "欢迎您：" + begin_class.allczyname.Trim() + "！ 欢迎使用本“" + Text.Trim() + "”";
        ...
        private void add_menu()
        {
            try
            {
                ...
                string sqlstring = "select ID,上级ID,名称,表单,级数,有下级  from z_menu_view order by 级数";
        ...
        void MenuClicked(object sender, EventArgs e)
        {
            try
            {
                ...
                string form_name_add = "djkdc_qg." + form_name;
                ...
                if (index == -1)
                {
                    ...
                    try
                    {
                        t = Activator.CreateInstance("djkdc_qg", form_name_add);
        ...
        private void 更改密码_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (index == -1)
                {
                    Form pass_update = new systemall.pass_update();
                    pass_update.MdiParent = this;
                    //passs.WindowState = FormWindowState.Maximized;
                    pass_update.StartPosition = FormStartPosition.CenterScreen;//窗体居中
                    pass_update.Show();
                }
                else
                {
